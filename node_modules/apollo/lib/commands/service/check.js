                ...
                return [
                    {
                        ...
                        task: async (ctx, task) => {
                            ...
                            const { compositionValidationResult, checkSchemaResult } = await project.engine.checkPartialSchema(Object.assign(Object.assign({ id: graphName, graphVariant: tag, implementingServiceName: serviceName, partialSchema: {
                                    sdl
